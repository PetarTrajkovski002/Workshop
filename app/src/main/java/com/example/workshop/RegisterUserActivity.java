...
public class RegisterUserActivity extends AppCompatActivity {
    ...
    public void Register(View view)
    {
        ...
        if(ime.isEmpty()||prezime.isEmpty()||broj.isEmpty()||email.isEmpty()||username.isEmpty()||password.isEmpty())
        {
            Toast.makeText(this,"Празни полиња",Toast.LENGTH_SHORT).show();
        }
        else if(!password.equals(confirm_password))
        {
            Toast.makeText(this,"Лозинките не се сопаѓаат",Toast.LENGTH_SHORT).show();
        }
        MyDatabaseHelper db=new MyDatabaseHelper(RegisterUserActivity.this);
        db.addKorisnik(ime,prezime,broj,email,username,password);
