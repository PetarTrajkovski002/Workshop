...
public class LoginUserActivity extends AppCompatActivity {
    ...
    public void Login(View view)
    {
        ...
        else
        {
            ...
            MyDatabaseHelper dbhelper=new MyDatabaseHelper(LoginUserActivity.this);
            ...
            else
            {
                ...
                Toast.makeText(this,"Пронајден е корисникот со тие податоци.",Toast.LENGTH_SHORT).show();;
